...
import static com.oxchains.themis.common.constant.JPushConst.APP_KEY;
import static com.oxchains.themis.common.constant.JPushConst.MASTER_SECRET;
import static com.oxchains.themis.common.constant.JPushConst.SUCCESS_CODE;
...
public class JPushUtils {
     ...
     * @return boolean
     */
    public static boolean sendToRegistrationId(String registrationId, String notificationTitle, String notificationSummary, String msgTitle, String msgContent, String extrasParam){
     ...
     * @return boolean
     */
    public static boolean sendToAllAndroid(String notificationTitle, String notificationSummary, String msgTitle, String msgContent, String extrasParam){
        boolean result = false;
        try {
     ...
     * @return boolean
     */
    public static boolean sendToAllAndroidAlias(Long userId, String notificationTitle, String notificationSummary, String msgTitle, String msgContent, String extrasParam){
        boolean result = false;
        try {
            PushPayload pushPayload = buildPushObjectAndroidAlias(userId, notificationTitle, notificationSummary, msgTitle, msgContent, extrasParam);
            PushResult pushResult = jPushClient.sendPush(pushPayload);
            if (pushResult.getResponseCode() == SUCCESS_CODE){
                result = true;
            }
     ...
     * @return boolean
     */
    public static boolean sendToAllIos(String notificationTitle, String msgTitle, String msgContent, String extrasParam) {
        boolean result = false;
        try {
     ...
     * @return boolean
     */
    public static boolean sendToAndroidAndIos(String notificationTitle, String msgTitle, String msgContent, String extrasParam){
        boolean result = false;
        try {
...
//        IosAlert iosAlert =  IosAlert.newBuilder().setTitleAndBody("title", "alert body").build();
    ...
    private static PushPayload buildPushObjectAndroidAlias(Long userId, String notificationTitle, String notificationSummary, String msgTitle, String msgContent, String extrasParam){
        LOG.info("----------buildPushObjectAndroidAllAlertWithTitle----------");
        return PushPayload.newBuilder()
        // 指定要推送的平台，all代表当前应用配置了的所有平台，也可以传android等具体平台
                .setPlatform(Platform.android())
