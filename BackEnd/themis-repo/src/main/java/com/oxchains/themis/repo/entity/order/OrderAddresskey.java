...
@Data
public class OrderAddresskey implements Serializable{
    @Id
    ...
    public OrderAddresskey(String orderId, String buyerPubAuth, String buyerPriAuth, String userPubAuth, String userPriAuth) {
